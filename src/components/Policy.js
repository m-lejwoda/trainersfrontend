...
const Policy = () => {
    ...
    <>
    <Navbar />
        <div className="policy homepage__policy">
            <div className="policy__title">Polityka prywatności</div>
<span className="policy__points">1. Informacje ogólne</span>
    Niniejsza polityka dotyczy Serwisu www, funkcjonującego pod adresem url: localhost:3000
    Operatorem serwisu oraz Administratorem danych osobowych jest: Michał Lejwoda
    Adres kontaktowy poczty elektronicznej operatora: saxatachi@gmail.com
    ...
    <span className="policy__points">2. Wybrane metody ochrony danych stosowane przez Operatora</span>
    ...
    <span className="policy__points">3. Hosting</span>
    Serwis jest hostowany (technicznie utrzymywany) na serwera operatora: cyberFolks.pl
    <span className="policy__points">4. Twoje prawa i dodatkowe informacje o sposobie wykorzystania danych</span>
    ...
    <span className="policy__points">5. Informacje w formularzach</span>
    ...
    <span className="policy__points">6. Logi Administratora</span>
    Informacje zachowaniu użytkowników w serwisie mogą podlegać logowaniu. Dane te są wykorzystywane w celu administrowania serwisem.
    <span className="policy__points">7. Istotne techniki marketingowe</span>
    Operator stosuje analizę statystyczną ruchu na stronie, poprzez Google Analytics (Google Inc. z siedzibą w USA). Operator nie przekazuje do operatora tej usługi danych osobowych, a jedynie zanonimizowane informacje. Usługa bazuje na wykorzystaniu ciasteczek w urządzeniu końcowym użytkownika. W zakresie informacji o preferencjach użytkownika gromadzonych przez sieć reklamową Google użytkownik może przeglądać i edytować informacje wynikające z plików cookies przy pomocy narzędzia: https://www.google.com/ads/preferences/
    <span className="policy__points">8. Informacja o plikach cookies</span>
    ...
    <span className="policy__points">9. Zarządzanie plikami cookies – jak w praktyce wyrażać i cofać zgodę?</span>
